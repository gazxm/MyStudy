...
export default class FOLoan extends React.Component {
  constructor (props) {
    super(props)
    this.state = {
      data: {
  ...
  render () {
    ...
    return (
      <div className='agreement loan'>
        ...
        <p>丙方（居间方）：上海浅橙网络科技有限公司</p>
        <p>丁方（居间方）：杭州义牛网络技术有限公司</p>
        <table>
          <tbody>
            <tr>
        ...
        <p>（注：因丙方或丁方开展运营活动，给予甲方部分服务费用减免的，具体还款金额等以丙方或丁方平台的运营规则与活动解释为准）</p>
        <h3>释义：</h3>
        <p>1、《借款协议》是指本协议（以下简称“借款协议”或“本协议”）及所有附件中的任何条款、明细和信息。本协议由甲、乙双方在线以类似点击确认方式视为认可并签署（具体名称以平台页面具体载明为准），并严格受其约束行使权利、履行义务。</p>
        ...
        <p>5、居间方丁方（“丁方”）是指《借款协议》中列明的杭州义牛网络技术有限公司，其是一家在杭州市合法成立并有效存续的有限责任公司，为甲、乙双方的借款搭建平台，提供信息服务、合同管理等平台服务，丁方有权收取综合服务费。</p>
        ...
        <h3>第一条 借款</h3>
        <p>1、借款标的各项相关内容以《借款标的明细》中列明的内容为准，甲方同意并授权丙方或丁方于借款起息日收取综合服务费，并在发放借款时即从本金金额中扣除，或不可撤销地授权丙方或丁方指定的第三方支付机构从甲方账户划扣。具体计算方式以甲方与丙方签订的《平台服务协议》为准。</p>
        <p>2、借款期限是指《借款标的明细》中列明的借款起息日起至借款到期日（最后一期还款日）之间的期间。</p>
        <p>3、起息日是指乙方的出借资金到达借款人账户开始计算利息的日期。</p>
        <p>4、还款日是指本协议约定的借款到期日。</p>
        ...
        <h3>第三条 逾期还款</h3>
        <p>1、甲方未能在任何一个还款日18:00前足额支付还款金额至甲方还款账户的，或未能通过经由丙方认可的其他方式进行还款操作的，视作逾期还款。</p>
        <p>2、甲方逾期还款的，自还款日后第一日起，应向丙方、丁方承担违约责任造成的损失及丙方因维护本协议下债权债务关系依约履行而产生的相关合理费用。</p>
        <p>3、甲方逾期还款的，应先就守约方的损失及维权费用进行赔偿、补偿，再按本协议项下的约定履行还款义务，顺序为：丙方或丁方实现债权的费用、综合服务费、利息、本金。</p>
        <p>4、甲方逾期还款的，乙方有权将债权转让给适格第三方。根据本协议项下的授权委托，丙方或丁方合作的第三方支付机构有权从甲方账户中代扣或向相应各方代还其应付款项，还款优先顺序如下：</p>
        <p>（1）逾期仅有一期的，还款顺序依次为实现债权的费用、逾期费用、利息、本金；</p>
        <p>（2）逾期多期的，优先偿还逾期在先的各期应还款项，各期应还款项的还款顺序为实现债权的费用、逾期费用、利息、本金。</p>
        <p>5、任何一期逾期超过5日，或者累计逾期达到3次或其它乙方、丙方认为甲方可能存在无法按期还款的情况发生（包括但不限于发生失业、停业、营业执照被吊销，或被监禁、被宣告失踪、处于限制民事行为能力或丧失民事行为能力状态，或涉及诉讼、仲裁、被司法机关采取强制措施等影响还款能力的情况），乙方授权丙方可以宣告借款提前到期，宣告提前到期时甲方的应还款项及顺序如下：</p>
        <p>（1）宣告提前到期当期之前已经产生的各期逾期费用，以及各期的居间费用、利息、本金；</p>
        <p>（2）宣告提前到期当期的居间费用、利息、本金；</p>
        <p>（3）宣告提前到期当期之后的全部剩余本金。</p>
        <p>如甲方未能于宣告提前到期当日偿还如上全部应还款金额，则除上述应还款金额外，还须自宣告提起到期之日后第一日起向丙方支付逾期费用，并优先于宣告到期后应支付的其他款项支付。</p>
        <p>6、甲方发生逾期超过3日，甲方个人信息将可能进入信用征信系统，由此产生的后果由甲方承担。</p>
        <p>7、甲方发生逾期情形的，乙方在此不可撤销的授权丙方以丙方名义进行催告，并授权丙方可转授权给丙方的合作方催告，催告方式包括但不限于：发送网站、APP推送通知，发送短信，发送函件、电话催告，提起诉讼/仲裁等。</p>
        <p>8、逾期费用：以逾期未还金额为基数按日收取，按照逾期未还金额计算，包括逾期未还本金、利息之和，以当日0:00至24:00为一日，债权人每日收取用户逾期未还金额的1%作为逾期费用，按国家法律规定，逾期费用超过本金年化利率36%的部分，不再计算与收取，但借款人仍应承担因借款人违约逾期还款，债权人诉诸维权的合理费用，包括但不限于：</p>
        <p>（1）因债权转让发生的税费；</p>
        ...
        <h3>第七条 承诺与保证</h3>
        <p>1、甲方及乙方各自在此确认为具有完全民事权利能力和完全民事行为能力的主体，有权签订并履行本协议，并充分知晓民间借贷行为可能存在的各类风险。</p>
        ...
        <p>3、乙方的债权受让方向乙方支付相关款项后，乙方、丙方、丁方应积极协助乙方的债权受让方向甲方追偿（包括但不限于签署、提供相应书面材料等），若因乙方原因导致债权受让方不能追偿的，乙方应向债权受让方承担赔偿责任或返还偿付款项。</p>
        <h3>第九条 证据和计算</h3>
        ...
        <p className='margin'>丁方（居间方）：杭州义牛网络技术有限公司</p>
