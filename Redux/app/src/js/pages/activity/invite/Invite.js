...
export default class Invite extends React.Component {
  ...
  forward () {
    location.href = resolveUrl('http://h.xianjincard.com/activity/invite-people-two')
  }
    ...
    const rule = ruleState ? <div className='rule'>
      ...
      <div className='dialog'>
        ...
        <div className='rule-content'>
          ...
          <p><b>好友奖励：</b></p>
          <p><b>首借免本息——</b>每天定点放出300个名额，按完成借款时间先后顺序为准，先到先得</p>
          <p><b>注册送120元红包——</b>好友注册后，系统将自动发放一张120元红包券（100元提额券、10元抵扣券、10元续期券）至其账户中，可至APP【我的】中查看，红包券有效期20天</p>
      ...
      <div className='transition-group'>
        <div className='invite'>
          ...
          <div class='coupon clearfix'>
            <p className='left'>
              <b className='number'>120</b>元<br />红包
            </p>
            <p className='right'>所有被邀请人注册后，<br />即可获取120元红包</p>
          </div>
          <h2>如何更好的邀请</h2>
          ...
          <p className='link' onTouchStart={this.copyText.bind(this)} onTouchEnd={this.copyEnd.bind(this)}>#借款新口子推荐#今天发现一个借款新口子：现金卡。最高<br />
            ...
            口子链接>> {link}</p>
          <h2 className='activity-h2'>活动推荐</h2>
