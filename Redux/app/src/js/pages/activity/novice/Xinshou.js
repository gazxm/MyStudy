  ...
  render () {
    return (
      <div className='transition-group'>
        <div className='Xinshou'>
          <div className='head'>
            <h3>活动时间</h3>
            <span>2017年5月26日至7月12日</span>
          </div>
          <div className='content'>
            <p>1. 2017年5月26日至7月12日，新注册首次申请并成功放款，即有机会获得【首次借钱不用还】的特权，每天限前100名 ， 按照放款顺序，先到先得；</p>
            <p>2. 获得特权的用户，只要在还款日前成功还款(未逾期)，即可享受【首次借钱不用还】，现金卡官方将全额返还首笔借款的本金+利息，真正做到“借钱不用还”；</p>
            <p>3. 获得特权的用户，如到期逾期还款，则视为自动放弃特权，不再退还本金+利息；</p>
            <p>4. 每位用户只有一次获奖机会，发现有用户通过不正当手段恶意刷奖，现金卡有权取消其获奖资格；</p>
            <p>5. 活动期间，新用户注册即可获得120元红包，红包内包含10元借款抵扣券一张（借款可用），10元续期抵扣券一张（续期可用），100元临时提额券一张（借款可用），以上所有红包券皆可在有效期内分开使用；</p>
            <p className='p1'> 本活动最终解释权归现金卡所有，与Apple.Inc无关。</p>
          </div>
          <div className='foot'>
