...
export default class Shop extends React.Component {
  ...
  fetchData () {
    ...
    if (!this.id) {
      ...
      Popup.click('a.click', () => {
        location.href = resolveUrl('http://h.xianjincard.com/activity/gold-powder?key=2')
      })
      return
    }
    Toast.loading('')
      ...
      <div className='transition-group'>
        <div className='shop-view'>
          ...
          <div className='content'>
            ...
            <div className='clearfix list'>
              <p className='left show'>消耗{goodsInfo.consume}次{goodsInfo.consume_text}既有机会抢</p>
