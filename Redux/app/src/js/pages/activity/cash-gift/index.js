    ...
    return (
      <div className={classnames({wrapper: true, loaded})}>
        ...
        <div className='button-group'>
          <div className='button button-receive' onClick={this.receive.bind(this)} />
          <div className='button button-check' onClick={this.check.bind(this)} />
        </div>
        <div className='rules'>
        ...
        <Modal className='prize' visible={visible} onClose={this.close.bind(this)} maskClosable transparent>
          <ul>
            {cash && (
            <li>
        ...
        <Modal className='prompt' visible={prompt === 1} onClose={this.prompt.bind(this)} maskClosable transparent>
          <p>主人，还没有登录哦~</p>
          <div class='button' onClick={this.login.bind(this)}>立即登录</div>
        </Modal>
        <Modal className='prompt' visible={prompt === 2} onClose={this.prompt.bind(this)} maskClosable transparent>
