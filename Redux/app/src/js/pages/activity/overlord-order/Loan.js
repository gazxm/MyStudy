...
export default class Loan extends React.Component {
  ...
  render () {
    ...
    const vidTd = data.vip_list && data.vip_list.length > 0 ? data.vip_list.map((v, i) =>
      <tr key={i}>
        <td>{v.plan_index}</td>
        <td>{v.money}</td>
        <td>{v.loan_date}</td>
    ...
    return (
      <div className='agreement loan'>
        ...
        <p>丙方平台收集的借款人甲方，通过第三方向出借人乙方借款，出借人乙方亦同意出借款项，现经三方协商一致，达成如下条款：</p>
        <table>
          <tbody>
            <tr>
              <th colSpan='6'>借款明细</th>
            </tr>
            <tr>
              <td colSpan='2'>借款总额</td>
              <td colSpan='4'>{data.amount ? `人民币${data.amount}元` : ''}</td>
            </tr>
            <tr>
              <td colSpan='2'>大写</td>
              <td colSpan='4'>{data.money ? `人民币${data.money}` : ''}</td>
            </tr>
            <tr>
              <td>借款用途</td>
              <td colSpan='2'>个人消费</td>
              <td>年化利率</td>
              <td colSpan='2'>{data.inter_rate ? `${data.inter_rate}` : ''}</td>
            </tr>
            <tr>
              <td>还款方式</td>
              <td colSpan='5'>一次性还本付息（具体以每次还款日为准）</td>
            </tr>
            <tr>
              <td>支取</td>
              <td>金额</td>
        ...
        <h3>释义</h3>
        <p>1、《借款协议》是指本协议（以下简称“借款协议”或“本协议”），其全部内容由甲、乙双方在线以类似点击确认等方式视为认可并签署，并严格受其约束行使权利、履行义务。</p>
        <p>2、借款人（“甲方”）是指《借款协议》中列明的符合中华人民共和国法律规定的具有完全民事权利能力和民事行为能力，<b>（非高等院校全日制学生）</b>，独立行使和承担本协议项下权利义务的个体。甲方为丙方平台上的注册用户，有借款需求。</p>
        <p>3、出借人（“乙方”）是指《借款协议》中列明的符合中华人民共和国法律规定的具有完全民事权利能力和民事行为能力，独立行使和承担本协议项下权利义务的个体，愿意出借合法取得的自有资金。</p>
        ...
        <p>5、甲方账户是指甲方在银行/第三方支付机构开立的用以接受借款，支付还款的相关账户。</p>
        <p>6、乙方账户是指乙方在银行/第三方支付机构开立的用以提供的发放借款，收取还款的相关账户。</p>
        <p>7、本协议项下甲方、乙方、丙方、丁方单独称“一方”，任意两方合称“双方”，任意三方合称“三方”，任意四方合称“各方”。</p>
        <p>8、工作日是指除国家法定节假日、公休日以外的丙方、丁方对外办理业务的任何一日。</p>
        <h3>第一条 借款</h3>
        <p>1、借款期限是指《借款明细》中列明的支取日至还款日（具体参照借款明细）之间的期间。</p>
        <p>2、借款支取日是指乙方的出借资金到达甲方账户开始计算利息的日期。</p>
        <p>3、还款日是指本协议约定的借款到期日，实际的还款日以甲方还款到达乙方账户之日为准。</p>
        <h3>第二条 正常还款</h3>
        <p>1、还款方式以“借款明细”中列明的方式为准，甲方须在还款日当日18:00前支付《借款明细》所对应的“还款金额”中列明的的款项至甲方还款账户。</p>
        <p>2、甲方应通过协议约定的还款方式进行还款操作，按时足额将还款金额支付至甲方还款账户，由于账户余额不足、账户原因、甲方操作失误等原因导致划款失败的由甲方承担相应责任。</p>
        <p>3、甲方不可撤销地授权丙方或第三方机构委托的银行／第三方支付机构有代收代扣本协议下还款相关款项的权利，从甲方还款账户中划扣甲方应还款项（如甲方逾期还款，应还款项包括逾期费用），银行/第三方支付机构在成功划转还款至乙方账户后视作甲方还款成功，由于账户余额不足、账户原因、甲方操作失误等原因导致划款失败的由甲方承担相应责任。</p>
        <p>4、乙方不可撤销地授权丙方或第三方机构委托的合作银行/第三方支付机构有代收代扣本协议下还款相关款项的权利，将还款本息支付至乙方账户。</p>
        <h3>第三条 逾期还款</h3>
        <p>1、甲方未能在任何一次到期日18:00前足额支付还款金额至甲方还款账户的，视作逾期还款。</p>
        <p>2、甲方逾期还款的，自还款日后第一日起，应向丙方承担违约责任造成的损失及丙方因维护本协议下债权债务关系依约履行而产生的相关合理费用，具体以甲方与丙方签订的《平台服务协议》为准。</p>
        <p>3、甲方逾期还款的，履行还款义务的顺序为：逾期违约金与守约方的损失及维权费用、利息、本金。</p>
        <p>4、甲方逾期还款的，乙方有权将债权转让给适格第三方。</p>
        <p>5、甲方发生逾期超过3日，甲方个人信息将可能进入信用征信系统，由此产生的后果由甲方承担。</p>
        <p>6、甲方发生逾期情形的，乙方在此不可撤销的授权丙方或第三方进行催告，催告方式包括但不限于：发送网站、APP推送通知，发送短信，发送函件、电话催告，提起诉讼/仲裁等。</p>
        ...
        <p>2、甲方选择提前结清的：甲方仍应按《借款协议》偿还事先约定的到期全额款项（包括但不限于利息、本金）。</p>
        <h3>第五条 债权、债务转让</h3>
        <p>1、未经乙方或乙方委托丙方事先书面（包括但不限于电子邮件等方式）同意，甲方不得将本协议项下的任何权利义务转让给任何第三方。</p>
        <p>2、乙方可通过签订《债权转让协议》向第三方转让本协议项下权利义务，转让后甲方即向新的债权人履行本协议项下全部义务；乙方将逾期债权转让给第三方的，违约金的追偿权一并转让，乙方不再享有任何与债权相关的权利。</p>
        <h3>第六条 费用</h3>
        <p>甲方、乙方已充分知晓丙方提供本协议所约定的服务，就该服务向甲方收取的综合服务费，并由甲方与丙方签署《平台服务协议》加以确认。</p>
        <h3>第七条 承诺与保证</h3>
        ...
        <p>3、甲方、乙方应及时并如实向对方及丙方及指定的其他第三方（银行/第三方支付机构等）提供个体信息（包括但不限于姓名、身份证号、企业或组织名称、统一社会信用代码、联系方式、联系地址、职业信息、联系人信息等）以及借款用途等相关信息。</p>
        <p>4、甲方、乙方承诺并保证向其丙方或合作第三方提供的所有本人信息均真实、完整、有效、及时。因上述任何本人信息及资料的变更、修改、停用等，至少提前2个工作日通知丙方或合作第三方。</p>
        <p>5、如甲方或乙方变更账户信息（账户名称、账号等）、通讯地址的，应当至少在款项交付日前2个工作日通知丙方。如甲方或乙方因未能遵守上述承诺而导致自身损失，自行承担，导致丙方损失的，承担赔偿责任。</p>
        ...
        <p>8、各方承诺，各方不会利用丙方平台进行信用卡套现、洗钱、非法集资或其他不正当交易行为，否则应依法独立承担法律责任。</p>
        <p>9、各方确认，甲方和乙方授权和委托丙方根据本协议所采取的全部行动和措施的法律后果均归属于甲方和乙方本人；在任何情形下，丙方不是本协议项下任何借款或债务的债务人或需要以其自有资金偿还本协议项下的任何借款或债务。</p>
        <p>10、甲方、乙方无法正常使用本协议项下，丙方或其合作方提供的服务时，有权追究责任，但因下列事项的，应免除责任：</p>
        <p>（1）系统维护、故障、黑客攻击、电信部门技术调整或故障、网站升级；</p>
        <p>（2）银行、第三方支付平台或金融相关等部门的意外事件；</p>
        <p>（3）法律法规及政策调整；</p>
        <p>（4）不可抗力</p>
        <p>11、各方知晓并认可丙方与银行、第三方支付机构的合作，确认并同意因资金在途或划转延迟等可能产生的收益归入丙方的居间酬劳。</p>
        <h3>第八条 违约</h3>
        ...
        <p>2、若甲方违约或丙方合理判断甲方可能发生违约事件的，乙方及/或乙方的债权受让人有权采取下列任何一项或几项救济措施：</p>
        <p>（1）立即暂缓、取消发放全部或部分借款；</p>
        <p>（2）宣告已发放借款全部提前到期，甲方应立即偿还所有应付款项；</p>
        <p>（3）解除本协议；</p>
        <p>（4）采取法律、法规以及本协议约定的其他救济措施。</p>
        <p>3、乙方的债权受让方向乙方支付相关款项后，乙方应积极协助乙方的债权受让方向甲方追偿（包括但不限于签署、提供相应书面材料等），若因乙方原因导致债权受让方不能追偿的，乙方应向债权受让方承担赔偿责任或返还偿付款项。</p>
        <p>第九条 证据和计算</p>
        ...
        <p>2、甲乙双方委托丙方对相关金额进行计算，并在丙方平台发布或更新具体信息。上述还款明细中列明的还款金额若与发布或更新的还款明细不一致的，以平台上发布或更新的还款明细为准。</p>
        <h3>第十条 保密条款</h3>
        <p>1、各方应将其在本协议及其附属合同、文件的签订和履行过程中取得的有关内容以及与此等内容有关的任何文件、资料或信息视为保密信息（以下简称“保密信息”）。</p>
        <p>2、任意一方向其他双方承诺，其不会使用或向非本协议方披露保密信息，除非事先得到其他三方的书面同意。</p>
        ...
        <h3>第十一条 知识产权</h3>
        <p>1、丙方及关联公司所有系统、提供的服务、本协议所有内容，包括但不限于产品名、商标、网站名、网站架构、网站画面、网站设计、著作、图片、档案等无形资产（包括但不限于商标权、专利权、著作权、商业秘密等）均由丙方或关联公司所有。</p>
        <p>2、非经丙方或关联公司书面同意，任何人不得擅自使用、修改、反向工程、反汇编、反编译、复制、公开传播、散布、发行或公开发表丙方程序或内容。</p>
        <p>3、尊重知识产权是甲方、乙方应尽的义务，任何人侵犯了丙方或关联公司的知识产权，应当承担损害赔偿责任，被侵害方拥有追究责任的权利。</p>
        <h3>第十二条 通知</h3>
        <p>1、本协议任何一方根据本协议约定做出的通知和/或文件均应以书面形式做出（不包括本协议第七条因贷后管理服务所涉内容），可由专人送达、挂号邮递、特快专递或通过丙方网络平台发布等方式传送，具体送达信息以本协议约定或各方在丙方平台的注册信息或登记信息为准。</p>
        <p>2、通知在下列日期视为送达：</p>
        ...
        <h3>第十四条 其他</h3>
        <p>1、甲方希望通过丙方运营平台向乙方借款，乙方亦同意借款。各方协商一致，达成本协议。</p>
        <p>2、本协议自出借资金到达甲方账户之日起生效，并开始计息。</p>
        <p>3、本协议中部分条款根据相关法律法规等的规定成为无效，或部分无效时，该等无效不影响本协议项下其他条款的效力，各方仍应履行其在本协议项下的义务。</p>
        <p>4、本协议项下的附件和补充协议构成本协议不可分割的一部分。</p>
        <p>5、本协议双方委托丙方保管所有与本协议有关的书面文件或电子信息；本协议双方确认并同意由丙方提供的与本协议有关的书面文件或电子信息在无明显错误的情况下应作为本协议有关事项的终局证明。</p>
