...
let prize = ['1天返现券', '2天返现券', '3天返现券', '5天返现券', '10个金币', '20个金币', '50个金币', '100个金币', '150个金币', '0.1元现金红包', '0.2元现金红包', '0.5元现金红包', '0.8元现金红包', '1元现金红包', '2元现金红包', '2元抵扣券', '5元抵扣券', '8元抵扣券', '10元抵扣券', '15元抵扣券', '100元提额券', '100M流量']
...
export default class Scroll extends React.Component {
  ...
  render () {
    ...
    const List = this.reward.map((v, i) => <li className='scroll-li' key={i}>恭喜<b>{v[0]}</b> 获得<b>{v[1]}</b></li>)
